...
browser.get('https://idm-japan.sakura.ne.jp/ems/staffmonthly/?setdatestaffmonth=2022/03/01&setstaffid=20')

extraction_test1 = browser.find_element(by=By.XPATH, value='/html/body/div[1]/table/thead/tr/th[12]')
extraction_test2 = browser.find_element(by=By.XPATH, value='/html/body/div[1]/table/tfoot/tr/td[12]')

# print(extraction_test1.text + "：" + extraction_test2.text + "\n")

def main():
    # Streamlit が対応している任意のオブジェクトを可視化する (ここでは文字列)
    st.write(extraction_test1.text + "：" + extraction_test2.text + "\n")
...
# ページのソースを表示する（テスト用）
# print(elem_scraping_page.page_source)